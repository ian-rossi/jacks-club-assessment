...
graph TD
    ...
    UnlockTransactionAggregateByUserId -->|If successful and source = CreateTransactionLambda, delete| EventBridgeScheduler
    UnlockTransactionAggregateByUserId -->|If not successful and source = CreateTransactionLambda, create| EventBridgeScheduler
    UnlockTransactionAggregateByUserId -->|If not successful and source = Scheduler, update| EventBridgeScheduler
