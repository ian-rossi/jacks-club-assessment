import { ConditionalCheckFailedException, IdempotentParameterMismatchException } from "@aws-sdk/client-dynamodb";
...
export class CreateTransactionUseCaseImpl extends UseCase<CreateTransactionInput, CreateTransactionOutput> {
    ...
    private async tryLockTransactionAggregate(userId: string): Promise<Big> {
        ...
        try {
            ...
            if (e instanceof ConditionalCheckFailedException) {
                const serviceUnavailableObj: RFC9457Output = {
                    status: 503,
                ...
                throw buildResponse(serviceUnavailableObj);
            }
            throw e;
        }
    }
